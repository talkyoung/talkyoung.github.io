	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;">学生积欠<font color="#FFCC00">ZY</font><span
		...
		<form action="/login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${ctx}/js/metronic/img/profile/sexy.jpg" alt="">
				...
				<div class="relogin">
						...
						<button type="submit" id="login-submit-btn" class="btn green"
							style="margin-left: 20px" onclick="document:loginform.submit()">
							学生登录 <i class="m-icon-swapright m-icon-white"></i>
						</button>
				</div>
			</div>
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1280*800. <br>2018 @ 三江学院 张益
			</div>
		</form>
	</div>
