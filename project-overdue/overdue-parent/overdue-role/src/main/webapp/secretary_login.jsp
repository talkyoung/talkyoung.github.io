...
<div class="page-lock">
	...
	<form action="/secretary/spring_security_secretaryLogin" method="post" id="loginForm">
		<div class="page-body">
			<img class="page-lock-img"
				 src="${ctx}/js/metronic/img/profile/school3.jpg" alt="" style="height:300px ">
			...
			<div class="relogin" style="text-align: center">
				...
				<button type="submit" id="login-submit-btn" class="btn red"
					...
					秘书登录 <i class="m-icon-swapright m-icon-white"></i>
				</button>
				<br/>
