    ...
    <table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
        <tr>
            <td class="left_nav_top">
                <div class="font1">教师资源管理</div>
            </td>
        </tr>
        <tr valign="top">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="../admin/assigndetail.html" target="main">任务分配详细</a></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="../admin/uploadVideo.html" target="main">视频资源管理</a></p>
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="../admin/uploadFile.html" target="main">文件资源管理</a></p>
        ...
        <tr>
            <td class="left_nav_top">
                <div class="font1">教师留言管理</div>
            </td>
        </tr>
        <tr valign="top">
            <td class="left_nav_bgshw">
                <p class="left_nav_link"><img src="${ctx}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a
                        href="../admin/comments.html" target="main">留言管理</a></p>
            </td>
        </tr>
        <tr>
            <td height="2"></td>
