...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/service/loginService.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/controller/indexController.js"></script>
</head>
<body ng-app="overdue" ng-controller="indexController"
	ng-init="showLoginName ()">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="320" height="80" class="topbg"><img
                    src="${ctx}/images/logo.gif" width="320" height="80"></td>
			<td class="topbg">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td height="50" class="toplink" align="right"><img
							src="${ctx}/images/top_home.gif">&nbsp;&nbsp;<a
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td class="topnavlh" align="left"><img
										src="${ctx}/images/StatBar_admin.gif">&nbsp;&nbsp;当前用户：
										<span style="color: black">{{loginName}}</span> 老师</td>
									<td class="topnavlh" align="right"><img
										src="${ctx}/images/StatBar_time.gif">&nbsp;&nbsp;<span
										id="nowTime"></span></td>
									<td width="3%"></td>
								</tr>
							</table>
